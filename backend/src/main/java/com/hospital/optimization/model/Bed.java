...
public class Bed {
    ...
    public Bed(String id, String bedNumber, String wardName, String department, String status, String assignedPatientId, String assignedPatientName) {
        this.id = id;
    ...
    public static class BedBuilder {
        ...
        public Bed build() {
            return new Bed(id, bedNumber, wardName, department, status, assignedPatientId, assignedPatientName);
        }
    }
}
