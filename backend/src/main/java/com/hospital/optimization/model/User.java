...
public class User {
    ...
    public User(String id, String name, String email, String password, String phone, UserRole role, boolean active,
                String gender, String dateOfBirth, String address, String emergencyContact, String specialization,
                String department, String roomNumber, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
        this.name = name;
        this.email = email;
    ...
    public static class UserBuilder {
        ...
        public User build() {
            return new User(id, name, email, password, phone, role, active, gender, dateOfBirth, address, emergencyContact, specialization, department, roomNumber, createdAt, updatedAt);
        }
    }
}
